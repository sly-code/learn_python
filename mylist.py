...
# index and slice
L = [1, 2, 3, 4, 5]
M = L[:3]       # M is a new list, not a part of L
L[1] = []
print("index assignment:", L, M)    # L is changed while M not
L[1:2] = []     # slice assignment: delete + insert
print("slice assignment:", L, M)
del L[2:]
...
t = copy.copy(L1[2])
print(t is L1[2], sys.getrefcount(t))
s1 = 'spam'
s2 = 'spam'
